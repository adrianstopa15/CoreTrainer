    ...
    <div className="mainpage">
      <div className="content-top">
        ...
        <div className="content-top--main -mt-24 text-center">
          <p className="md:text-5xl xl:text-8xl tracking-widest mt-32">
          ...
          <button className="button-main mt-12 lg:mt-24">
            Zacznij już teraz
          </button>
        </div>
      </div>
      ...
      <footer className="main-footer">
        <p className="pt-5 mx-12 lg:mx-36 text-xs text-center footer-text">
          ...
          uprzedniej zgody właściciela są surowo zabronione.
        </p>
        <div className="footer-container mx-20">
          {/* <p className='mr-4 mt-1 text-sm'>Linki do ewentualnego kontaktu</p> */}
          {/* <div>
            <img src={email} className="icons-main" />
          </div>
          <div>
            <img src={linkedin} className="icons-main" />
          </div>
          <div>
            <img src={instagram} className="icons-main" />
          </div> */}
        </div>
      </footer>
    </div>
